...
- Stablecoins can be used in a lending protocol,  Cross-border payment  and Treasury and Deposit where we have high inflation that don’t have access to USD Stable coins. Moat includes Tokenization, Merchant payment, Compliance and Privacy.
...
> Chart - 1 : Stable coins by supply , Source: DefiLlama , Data as 4.July.2026
 
The chart indicates that Fiat-collateralize players like USDT, USDC have strong penetration in stablecoin eco-system. Which include 
...
> Chart 2: Stablecoin with pegged mechanism  type, Source: DefiLlama , Data as 4.July.2026
...
The HKD's peg to the USD is widely regarded as one of the most successful in history. It has withstood numerous extreme market conditions. 
...
- First, **a commitment to maintain a backing ration of 100% or more**. This is crucial to for markets to assure full redemptions can always be met.
    - For HKD - 111.5% as of June. Maintained between 105% and 112.5%
    - For USDT - Slightly above 100%, with a 3% “excess reserve” as of June
...
- Second, **the asset allocation within the backing portfolio should be primarily designed to handle large redemption events, rather than to generate financial returns**. This ensure the ability to meet larger redemption in both normal and stressful times. 
    - HKD: Backing asset managed by the Exchange Fund in a segregated portfolio with high-quality, highly liquid US dollar-denominated assets.	
    - USDT: Cash and equivalent (U.S. treasury bills, reverse repos, etc) accounts for roughly 80%; rest include secured loans, bitcoin, gold, and other investments
...
> Chart 3: Stablecoin with pegged currently type, Source: DefiLlama , Data as 4.July.2026
